...
<div id="wrap">
	...
	<table border="1" class="bbs">
		...
		<tr>
			<td>(${bo.likecnt})<input type="button" value="좋아요" onclick="addLinke()"/></td>
			<td colspan="4" align="right"><input type="button" value="글수정"
				onclick="location.href='../admin/boardUpdateFrmAction.yo?num=${num}&pageNum=${pageNum}'">
				<input type="button" value="글삭제"
				onclick="location.href = '../admin/boardDeleteAction.yo?num=${num}&pageNum=${pageNum}'">
				<input type="button" value="글목록"
				onclick="location.href = '../admin/boardListAction.yo?pageNum=${pageNum}'"></td>
		</tr>
	</table>
	</div>
