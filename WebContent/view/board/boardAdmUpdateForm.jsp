...
<form id="frm" name="frm" action="../admin/boardUpdateProc.yo" method="post" enctype="multipart/form-data">
	<%--파라미터 릴레이용 --%>
	...
	<table align="center" width="70%">
		<tr>
			<td colspan="2" align="center">
				...
				<input type="button" class="btn2" id="bBtn" value="목록" onclick="location.href='/admin/boardBoardList.yo?oriNo=${oriNo}&nowPage=${nowPage }'">
			</td>
		</tr>
	</table>
</form>
