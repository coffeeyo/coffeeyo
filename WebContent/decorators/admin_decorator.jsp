    	...
    	<div class="container">
    		<div class="navbar-header">
          	...
          	<div class="navbar-collapse collapse">
	              ...
	              <li <c:if test="${conPath eq '/admin/orderManage.yo'}">class="active"</c:if>><a href="/admin/orderManage.yo">주문관리</a></li>
	              <li <c:if test="${conPath eq '/admin/memberListAction.yo'}">class="active"</c:if>><a href="/admin/memberListAction.yo">회원관리</a></li>
	              <li <c:if test="${conPath eq '/admin/boardListAction.yo'}">class="active"</c:if>><a href="/admin/boardListAction.yo">커뮤니티관리</a></li>
	              <li><a href="/">홈페이지</a></li>
